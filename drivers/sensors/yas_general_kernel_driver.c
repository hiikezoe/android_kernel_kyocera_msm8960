...
#elif SENSOR_TYPE == 101
#define SENSOR_NAME "sw_gyroscope"
#endif
...
static DEVICE_ATTR(data, S_IRUSR|S_IRGRP, sensor_data_show, NULL);
static DEVICE_ATTR(status, S_IRUSR|S_IRGRP, sensor_status_show, NULL);
